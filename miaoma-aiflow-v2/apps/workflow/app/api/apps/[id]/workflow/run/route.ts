 ...
 *   All rights reserved.
 *   妙码学院官方出品，作者 @Heyi，供学员学习使用，可用作练习，可用作美化简历，���可开源。
 */

import { createWorkflowEngine, NodeKind, WorkflowDefinition } from '@miaoma-aiflow/ai-engine'
...
import { registerRemotePluginNodesForWorkflow, type WorkflowEngineLike } from '@/lib/services/plugin-runtime-service'
import type {
    ErrorEventData,
    NodeEndEventData,
    NodeStartEventData,
        ...
        const stream = new ReadableStream({
            async start(controller) {
                ...
                try {
                    ...
                    await registerRemotePluginNodesForWorkflow({
                        engine: engine as unknown as WorkflowEngineLike,
                        workflow,
                        userId,
                    })
