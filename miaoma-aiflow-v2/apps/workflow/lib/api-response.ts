...
export enum ErrorCode {
    ...
    PLUGIN_VERSION_NOT_FOUND = 'PLUGIN_VERSION_NOT_FOUND',
...
export const ErrorCodeHttpStatusMap: Record<ErrorCode, number> = {
    ...
    [ErrorCode.PLUGIN_ALREADY_EXISTS]: 400,
    [ErrorCode.PLUGIN_VERSION_NOT_FOUND]: 404,
    [ErrorCode.PLUGIN_ALREADY_INSTALLED]: 400,
    [ErrorCode.PLUGIN_NOT_INSTALLED]: 400,
    [ErrorCode.PLUGIN_PERMISSION_DENIED]: 403,
...
export const ErrorCodeMessageMap: Record<ErrorCode, string> = {
    ...
    [ErrorCode.PLUGIN_ALREADY_EXISTS]: '插件已存在',
    [ErrorCode.PLUGIN_VERSION_NOT_FOUND]: '插件版本不存在',
    [ErrorCode.PLUGIN_ALREADY_INSTALLED]: '插件已安装',
    [ErrorCode.PLUGIN_NOT_INSTALLED]: '插件未安装',
    [ErrorCode.PLUGIN_PERMISSION_DENIED]: '插件权限不足',
