...
const SMTP_CONFIG = {
    ...
    auth: {
        ...
        pass: process.env.SMTP_PASSWORD || 'ABgdjZqKfvpTTiaX',
    },
} as const
...
const FROM_CONFIG = {
    name: '妙码 AI 工作流',
    address: 'miaomaedu@163.com',
} as const

/**
 * 收件人配置（开发环境重定向）
 */
const TO_OVERRIDE = process.env.NODE_ENV === 'development' ? process.env.EMAIL_OVERRIDE_TO || 'devmiaomaedu@163.com' : null
